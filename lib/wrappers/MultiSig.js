...
var MultiSigWrapper = /** @class */ (function (_super) {
     ...
     */
    MultiSigWrapper.prototype.submitOrConfirmTransaction = function (destination, txObject) {
        return __awaiter(this, void 0, void 0, function () {
            var data, transactionCount, transactionId, transaction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = BaseWrapper_1.stringToBytes(txObject.encodeABI());
                    ...
                    case 4:
                        transactionId--;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, BaseWrapper_1.toTransactionObject(this.kit, this.contract.methods.submitTransaction(destination, 0, data))];
                }
            });
        });
    };
