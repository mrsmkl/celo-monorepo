...
var ShowMetadata = /** @class */ (function (_super) {
    __extends(ShowMetadata, _super);
    function ShowMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ShowMetadata.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res, metadata;
            return __generator(this, function (_a) {
                res = this.parse(ShowMetadata);
                metadata = identity_1.IdentityMetadataWrapper.fromFile(res.args.file);
    ...
    ShowMetadata.flags = __assign({}, base_1.BaseCommand.flags);
