...
export default class VerifyProofOfPossession extends BaseCommand {
    ...
    static flags: {
        signer: import("@oclif/command/lib/flags").IOptionFlag<string>;
        account: import("@oclif/command/lib/flags").IOptionFlag<string>;
        signature: import("@oclif/command/lib/flags").IOptionFlag<string>;
