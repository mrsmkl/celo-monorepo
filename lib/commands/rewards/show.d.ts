...
export default class Show extends BaseCommand {
    ...
    static flags: {
        voter: flags.IOptionFlag<string | undefined>;
        validator: flags.IOptionFlag<string | undefined>;
        group: flags.IOptionFlag<string | undefined>;
        slashing: import("@oclif/parser/lib/flags").IBooleanFlag<boolean>;
        epochs: import("@oclif/parser/lib/flags").IOptionFlag<number>;
