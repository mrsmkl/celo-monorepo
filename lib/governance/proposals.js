...
var ProposalBuilder = /** @class */ (function () {
    ...
    ProposalBuilder.prototype.addTx = function (tx, params) {
        ...
        var _a, _b, _c, _d;
        var to = (_a = params.to, (_a !== null && _a !== void 0 ? _a : (_b = tx.defaultParams) === null || _b === void 0 ? void 0 : _b.to));
        var value = (_c = params.value, (_c !== null && _c !== void 0 ? _c : (_d = tx.defaultParams) === null || _d === void 0 ? void 0 : _d.value));
        if (!to || !value) {
