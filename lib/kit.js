...
var ContractKit = /** @class */ (function () {
    ...
    ContractKit.prototype.getTotalBalance = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var goldToken, stableToken, lockedGold, exchange, goldBalance, lockedBalance, dollarBalance, pending, err_1, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 11:
                        ...
                        _c = (_b = goldBalance
                            .plus(lockedBalance)).plus;
                        return [4 /*yield*/, exchange.quoteUsdSell(dollarBalance)];
                    case 12: return [2 /*return*/, (_a.total = _c.apply(_b, [_d.sent()])
                            .plus(pending),
                            _a.pending = pending,
                            _a)];
                }
